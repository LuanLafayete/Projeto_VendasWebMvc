...
namespace VendasWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //Verifica que o BD já foi populado
            }
            ...
            Seller s6 = new Seller(6, "Alex Pink", "Alexp@gmail.com", new DateTime(1997, 3, 4), 3000.00, d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.00, SalesStatus.Billed, s1);
